            ...
            <ContactSectionText>
              <Text type="heading2" color="grey4">
                ...
                <Text as="span" type="heading2" color="brand1">
                  desenvolveremos soluções para sua empresa
                </Text>
                , juntos!
              </Text>
            </ContactSectionText>
          ...
          <ContactsCards>
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Estou diponivel para qualquer duvida só chamar!
                </Text>
                <Text
                  as="a"
                  color="grey2"
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Me envie duvidas, ideias ou sugestões, feedbacks são sempre bem vindos
                </Text>
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Podemos ter uma interação maior la, me siga!
                </Text>
                <Text
                  as="a"
                  color="grey2"
